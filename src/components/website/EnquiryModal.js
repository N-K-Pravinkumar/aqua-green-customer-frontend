      ...
      <div className="modal" style={{ maxWidth:500 }}>
        {success ? (
          <div style={{ textAlign:'center', padding:'24px 0' }}>
            ...
            {product && <div style={{ background:'#f0fff0', borderRadius:10, padding:'10px 16px', marginBottom:20, fontSize:13, color:'#009B00', fontWeight:600 }}>Enquiry for: {product.name}</div>}
          ...
          <>
            <div className="modal-header">
              <div>
                ...
                {product && (
                  <div style={{ fontSize:13, color:'#007A00', marginTop:4, fontWeight:600 }}>
